...
insert into generic_user(address, email,enabled,last_password_reset_date,name,password,profile_picture,surname,telephone_number) values ('221b Baker Street','passenger@gmail.com',true,null,'peter','','','jackson','123')
