...
public class ModalPanic {
	@FindBy(how = How.CSS, using = "#modal-panic-reason")
	private WebElement textboxReason;
	
	@FindBy(how = How.CSS, using = "#modal-panic-ok")
	private WebElement btnOk;
	
	@FindBy(how = How.CSS, using = "#modal-panic-cancel")
	private WebElement btnCancel;
	
	private WebDriver driver;
	public ModalPanic(WebDriver webdriver) {
